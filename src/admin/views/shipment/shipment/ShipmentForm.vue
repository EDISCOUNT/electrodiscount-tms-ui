                                ...
                                <v-row>
                                    ...
                                    <v-col cols="12" md="6">
                                        <v-text-field v-model="data.netWeight" label="Net Weight" variant="outlined"
                                            density="compact" append-inner-icon="mdi-weight" type="number"></v-text-field>
                                    </v-col>
                                    <v-col cols="12" md="6">
                                    ...
                                    <v-col cols="12" md="6">
                                        <v-text-field v-model="data.channelOrderId" label="Order ID(Required)"
                                            :rules="[(v) => !!v || 'Order ID is required']" placeholder="Enter the Order Id"
                                            hint="Enter the ID of the order on the channel where the corresponding order was placed"
                                            variant="outlined" density="compact"></v-text-field>

                                        <v-row>
                                            <v-col :cols="4">
                                                <v-combobox v-model="data.codCurrency" label="Currency" variant="outlined"
                                                    density="compact" append-inner-icon="mdi-currency-usd"
